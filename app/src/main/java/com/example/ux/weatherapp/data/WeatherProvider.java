 ...
 */
package com.example.ux.weatherapp.data;
...
/**
 * This class serves as the ContentProvider for all of Weather App's data. This class allows us to
...
public class WeatherProvider extends ContentProvider {
    ...
    /**
     * Handles requests to insert a set of new rows. We are only going to be
    ...
    /**
     * Handles query requests from clients. We will use this method in to query for all
