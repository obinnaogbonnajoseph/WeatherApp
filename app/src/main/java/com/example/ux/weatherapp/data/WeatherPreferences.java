...
public final class WeatherPreferences {
    ...
    /**
     * Returns true if the user prefers to see notifications from Weather, false otherwise. This
    ...
    public static long getLastNotificationTimeInMillis(Context context) {
        /* Key for accessing the time at which Weather last displayed a notification */
